...
function test() {
  ...
  // !테스트 결과 YoutubeExternalSubtitle 자체가 iframe을 재생성함
  ...
  // if (!youtubeFrame) {
    ...
    // ?iframe 로딩보다 쿼리가 늦으니까 현재는 동작, 수정필요
    setSrt().then(() => {
      console.log(subtitle)
      const exSubtitle = new YoutubeExternalSubtitle.Subtitle(document.querySelector('iframe'), subtitle);
  ...
  return (
    ...
    <div>
        ...
        <iframe width="640" height="360" src="https://www.youtube.com/embed/fGPPfZIvtCw" allowFullscreen="true"></iframe>
      </div>
    </>
  )
}
